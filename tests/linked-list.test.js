...
//   xit('should return the value of the first node when kth from end is equal to the first node', () => {
...
//   xit(`should return 'Empty List' when there are no nodes`, () => {
...
//   xit(`should return 'List is too small' when there are no nodes`, () => {
...
xdescribe('Test for inserting a node kth from the end', () => {
  ...
  xit('should return the value of the last node when kth from end is equal to the last node', () => {
    ...
    actual = actual.merge(firstList, secondList);
    console.log(actual);
    const expected = '1';
